function deleteEntry(element){
    ...
    var confirmationPopup = confirm("Are you sure you want to delete this zoo?");
...
function initializeEditEntry(element){
    ...
    $.ajax({
        ...
        complete: function (data) {
            ...
            $("#editedZooID").val(employeeInfo[0]['Zoo ID'])           
            $("#editZooName").val(employeeInfo[0]['Name']);
            $("#editStreetAddress").val(employeeInfo[0]['Street Address']);
            $("#editZipCode").val(employeeInfo[0]['Zip Code']);
            $("#editCity").val(employeeInfo[0]['City']);
            $("#editState").val(employeeInfo[0]['State']);
            $("#editPhone").val(employeeInfo[0]['Phone']);
            $("#editEmail").val(employeeInfo[0]['Email']);
            $("#editOpHours").val(employeeInfo[0]['Operation Hours']);
